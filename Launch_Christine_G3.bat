...
title Christine G3 v2.1 PRISM + ATLAS-138
color 0B
cd /d "%~dp0"
echo.
echo ====================================================================================================
echo  Christine G3 v2.1 - PRISM Multi-View Answers + ATLAS-138
echo  Intent ^> Context ^> 138B/LongDoc/ORBIT ^> FactGraph ^> PRISM ^> Verify ^> NOVA
...
if %ERR% NEQ 0 (
    echo.
    echo [!] Christine G3 v2.1 exited with code %ERR%
